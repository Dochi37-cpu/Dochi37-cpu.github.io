...
- `publications.html` — P2E output status separated from PI background/collaborative record
...
1. Do not label a result as P2E-originated unless the work was substantially developed through P2E.
